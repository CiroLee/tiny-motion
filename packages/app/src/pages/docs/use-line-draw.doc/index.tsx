  ...
  return (
    <>
      ...
      <Playground className="mb-4 flex flex-col items-center justify-center px-8">
        ...
        <Button size="sm" className="absolute right-3 bottom-3" onClick={() => controller1.play()}>
          play
        </Button>
      </Playground>
      ...
      <Playground className="mb-4 flex flex-col items-center justify-center px-8">
        ...
        <Button size="sm" className="absolute right-3 bottom-3" onClick={() => controller2.play()}>
          play
        </Button>
      </Playground>
      ...
      <Playground className="mb-4 flex flex-col items-center justify-center px-8">
        <svg id="smile" width="120" height="120" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="12" r="11" />
          <path d="M17 8V8" />
          <path d="M7 8V8" />
          <path d="M7 13.4571C8.61278 16.5791 15 17 17 13" />
        </svg>
        <Button size="sm" className="absolute right-3 bottom-3" onClick={() => controller3.play()}>
          play
        </Button>
      </Playground>
